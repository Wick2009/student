...
This section reviews all the questions I got wrong on the AP CSP multiple-choice section, including the full question, all options, and reasoning.
...
**Reasoning:** Integer division truncates the decimal. In standard division for AP CSP MCQ, `2 ÷ 3` produces the decimal `0.666…`.
</details>
...
**Reasoning:** Sorting first makes it easier to group and count customers efficiently; iterating without sorting may miss grouping.
</details>
...
B. Open standards and protocols provide ways for users to eliminate the latency of messages they send on the Internet.  
C. Open standards and protocols allow users to freely share or reuse material found on the Internet for noncommercial purposes.  
D. Open standards and protocols prevent developers from releasing software that contains errors.  

**Your answer:** (blank)  
**Correct answer:** A  

**Reasoning:** Open standards ensure interoperability across devices and platforms.
</details>
...
**Reasoning:** Increasing bit size allows more addresses, but AP CSP MCQ answer context indicates the correct understanding is about unique addresses in IPv6; double-check source material for exact reasoning.
</details>
...
**Reasoning:** The correct runtime is O(n) because each customer/order must be processed once.
</details>
...
**Reasoning:** This is an undecidable problem; no algorithm can determine infinite loops for all programs and inputs.
</details>
...
**Reasoning:** Public key cryptography uses a key pair (public/private) for encryption and decryption.
</details>
...
**Options:**  
A. Two codes for a locked box, each for different actions  
...
**Reasoning:** Symmetric encryption uses the same key to encrypt and decrypt messages.
</details>
...
**Question:** What is the result of calling the `KeepPlaying` procedure in this code segment?
...
**Reasoning:** The procedure loops based on a condition, not immediately.
</details>
...
**Options:**  
A. Data stored in a single database  
B. Automation of tasks without human input  
...
**Reasoning:** Crowdsourcing leverages many people online to contribute to tasks or data collection.
</details>
...
**Reasoning:** Abstraction reduces complexity and can prevent certain errors; AP CSP MCQ grading may award both.
</details>
...
**Reasoning:** Online offers hyperlinks/multimedia; B is correct in AP context (cost); understanding requires careful reading.
</details>
...
**Question:** If `isPrime` returns 1 for numbers 1-10, which numbers are prime?
...
**Reasoning:** The procedure’s logic marks numbers 4 and 9 as primes incorrectly due to a specific test; check implementation details.
</details>
